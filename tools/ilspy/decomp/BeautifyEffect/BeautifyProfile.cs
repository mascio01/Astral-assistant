...
public class BeautifyProfile : ScriptableObject
{
	...
	[Range(1f, 4f)]
	public float anamorphicFlaresLayerMaskDownsampling = 1f;
	...
	public CullMode depthOfFieldTransparencyCullMode = CullMode.Back;
	...
	public CullMode depthOfFieldExclusionCullMode = CullMode.Back;
	...
	[Range(0f, 5f)]
	public float tonemapGamma = 2.5f;
	...
	private void OnValidate()
	{
		...
		bloomAntiflickerMaxOutput = Mathf.Max(0f, bloomAntiflickerMaxOutput);
		bloomDepthAtten = Mathf.Max(0f, bloomDepthAtten);
		anamorphicFlaresIntensity = Mathf.Max(0f, anamorphicFlaresIntensity);
		anamorphicFlaresAntiflickerMaxOutput = Mathf.Max(0f, anamorphicFlaresAntiflickerMaxOutput);
		antialiasDepthAtten = Mathf.Max(0f, antialiasDepthAtten);
		sunFlaresRadialOffset = Mathf.Max(0f, sunFlaresRadialOffset);
	}
}
