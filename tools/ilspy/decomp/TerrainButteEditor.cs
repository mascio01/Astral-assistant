...
public class TerrainButteEditor : DebugMenu
{
	...
	public TerrainButteEditor()
		: base(GameImpl.Translate("DEBUG_ButteEditor"))
	{
		Items.Add(new DebugMenuItemAdjuster(GameImpl.Translate("DEBUG_PlateauRadius"), DecrementPlateauRadius, IncrementPlateauRadius, BuildPlateauRadiusString));
	...
	public override void HandleInputImpl(InputFrame inputFrame)
	{
		...
		if (instance3.IsPressed(InputFunction.MainAction))
		{
			...
			if (raycastResult.HitObject == instance2)
			{
				...
				{
					instance2.DrawButte(raycastResult.Tile, _baseHeight, _plateauRadius, _radius, _scale, TerrainHeightEditor.LockRivers, TerrainHeightEditor.LockRoads);
